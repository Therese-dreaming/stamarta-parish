        ...
        <div class="px-6 py-6 relative">
            ...
            <div class="flex justify-between items-center relative z-10">
                <div>
                    ...
                    <p class="text-white/80 text-sm">Manage your ministry members and their information</p>
                </div>
        ...
        <div class="p-4">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200 animate-slideInUp" style="animation-delay: {{ $loop->index * 50 }}ms">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('ministry.members.edit', $member) }}" class="w-7 h-7 rounded-lg bg-indigo-100 hover:bg-indigo-200 flex items-center justify-center text-indigo-600 hover:text-indigo-800 transition-all duration-200 hover:scale-110" title="Edit">
            ...
            @else
                <div class="text-center py-8 animate-fadeIn">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('ministry.members.create') }}" class="inline-flex items-center px-4 py-2 bg-[#0d5c2f] text-white rounded-lg hover:bg-[#0a4a26] transition-colors duration-200">
...
@foreach($members as $member)
    ...
    <x-modal 
        ...
        <form action="{{ route('ministry.members.destroy', $member) }}" method="POST">
            @csrf
            @method('DELETE')
        </form>
    </x-modal>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function showTableView() {
            if (window.innerWidth >= 768) { // md breakpoint
                ...
                // Save preference
                localStorage.setItem("ministryMemberViewPreference", "table");
            }
        }
        ...
        function showCardView() {
            if (window.innerWidth >= 768) { // Only allow card view on desktop
                ...
                // Save preference
                localStorage.setItem("ministryMemberViewPreference", "card");
            }
        }
        ...
        const savedPreference = localStorage.getItem("ministryMemberViewPreference");
        ...
        window.addEventListener("resize", function() {
            if (window.innerWidth < 768) {
                ...
                const currentPreference = localStorage.getItem("ministryMemberViewPreference");
