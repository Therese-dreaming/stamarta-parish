...
@section('title', 'New Cash Inflow Request')
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">New Cash Inflow Request</h1>
                        <p class="text-gray-600 mt-1">{{ $ministry->name }} - Submit Cash Inflow Request</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-[#0d5c2f] to-[#0a4a26] px-8 py-6">
                        ...
                        <p class="text-white/80 text-sm mt-1">Fill in the details below to submit a new cash inflow request</p>
                    </div>

                    <!-- Form Content -->
                    <form action="{{ route('ministry.manual-cash-inflows.store') }}" method="POST" class="p-8">
                        @csrf
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select name="source_type" 
                                        ...
                                        <option value="fundraising" {{ old('source_type') === 'fundraising' ? 'selected' : '' }}>🎪 Fundraising</option>
                                        <option value="event_revenue" {{ old('source_type') === 'event_revenue' ? 'selected' : '' }}>🎉 Event Revenue</option>
                                        <option value="membership_fee" {{ old('source_type') === 'membership_fee' ? 'selected' : '' }}>👥 Membership Fee</option>
                                        <option value="sponsorship" {{ old('source_type') === 'sponsorship' ? 'selected' : '' }}>🤝 Sponsorship</option>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-3 text-sm text-blue-800">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <span>All cash inflow requests require admin approval</span>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <i class="fas fa-check-circle text-blue-600 mt-1 text-xs"></i>
                                    <span>Once approved, funds are added to {{ $ministry->name }}</span>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <i class="fas fa-edit text-blue-600 mt-1 text-xs"></i>
                                    <span>Pending requests can be edited or deleted</span>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <i class="fas fa-bell text-blue-600 mt-1 text-xs"></i>
                                    <span>You'll receive notifications on status changes</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-2xl p-6 shadow-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-purple-800 mb-4">If you have questions about submitting cash inflow requests, contact your ministry head or admin.</p>
