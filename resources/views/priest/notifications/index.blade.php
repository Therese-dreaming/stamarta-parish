...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="border-b border-gray-200">
        <nav class="flex space-x-8 px-6" aria-label="Tabs">
            ...
            <button class="tab-button py-4 px-1 border-b-2 font-medium text-sm transition-colors border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" data-tab="admin">
                Admin/Staff
            </button>
...
function switchTab(tab) {
    ...
    window.location.href = '{{ route("priest.notifications.index") }}?tab=' + tab;
}
