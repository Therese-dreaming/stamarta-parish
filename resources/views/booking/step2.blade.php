            ...
            <form action="{{ route('booking.step2.store', $service) }}" method="POST" class="p-6">
                ...
                <div class="mb-8">
                    ...
                    <div class="max-w-4xl mx-auto">
                        <x-calendar :activeBookings="$activeBookings" :selectedDate="$selectedDate" :service="$service" :parochialActivities="$parochialActivities" :ministryActivities="$ministryActivities" />
                    </div>
