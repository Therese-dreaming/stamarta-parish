...
<div class="font-[Poppins]">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.cms.media.index') }}" class="text-[#0d5c2f] hover:underline">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <form action="{{ route('admin.cms.media.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 flex justify-end space-x-3">
                <a href="{{ route('admin.cms.media.index') }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-500 transition-colors">
                    Cancel
                </a>
