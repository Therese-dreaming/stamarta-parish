...
<div class="space-y-4">
	<div class="bg-gradient-to-r from-[#0d5c2f] to-[#0d5c2f]/90 rounded-xl shadow-md overflow-hidden">
		<div class="px-6 py-6 relative">
			...
			<div class="flex justify-between items-center relative z-10">
				<div>
					<h1 class="text-2xl font-bold text-white flex items-center"><i class="fas fa-people-group mr-2"></i>Create Ministry</h1>
					<p class="text-white/80 mt-1 text-sm">Add a new ministry and optionally assign its head</p>
				</div>
	...
	<div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
		<form action="{{ route('admin.ministries.store') }}" method="POST" id="ministryForm">
			@csrf
			...
			<div class="p-4 space-y-4">
				<div>
					...
					<div class="relative">
						...
						<input name="name" value="{{ old('name') }}" class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm" required />
					</div>
				...
				<div>
					...
					<div class="relative">
						...
						<input name="slug" value="{{ old('slug') }}" class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm" placeholder="auto-generated if empty" />
					</div>
				...
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-1">Head (optional)</label>
					<div class="relative">
						...
						<input type="text" id="head_search" class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm" placeholder="Type name or email..." autocomplete="off" />
				...
				<div>
					...
					<div class="relative">
						...
						<textarea name="description" rows="4" class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm">{{ old('description') }}</textarea>
					</div>
			...
			<div class="p-4 border-t bg-gray-50 flex justify-end">
				<button type="submit" class="px-4 py-2 bg-[#0d5c2f] text-white rounded-lg hover:bg-[#0a4a26] text-sm flex items-center"><i class="fas fa-save mr-2"></i>Create Ministry</button>
			</div>
		</form>
	</div>
</div>
