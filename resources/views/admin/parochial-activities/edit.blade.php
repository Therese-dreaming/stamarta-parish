...
<div class="space-y-5">
    ...
    <div class="bg-gradient-to-r from-[#0d5c2f] to-[#0d5c2f]/90 rounded-lg shadow-md overflow-hidden">
        <div class="px-5 py-5 relative">
            ...
            <div class="flex justify-between items-center relative z-10">
                <div>
                    <h1 class="text-xl font-bold text-white">Edit Parochial Activity</h1>
                    <p class="text-white/80 mt-1.5 text-sm flex items-center">
                        <i class="fas fa-edit mr-2 text-sm"></i>Update parish event or activity
                    </p>
                </div>
    ...
    <!-- Form -->
    <form action="{{ isset($isStaff) && $isStaff ? route('staff.parochial-activities.update', $parochialActivity) : route('admin.parochial-activities.update', $parochialActivity) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="group">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm transition-all duration-200 group-hover:border-[#0d5c2f]/50 resize-y">{{ old('description', $parochialActivity->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-xs text-red-600 flex items-center">
                            <i class="fas fa-exclamation-circle mr-1 text-xs"></i>{{ $message }}
                        </p>
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            <div class="p-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <h2 class="text-base font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-calendar-alt mr-2.5 text-[#0d5c2f] text-base"></i>
                    Date and Time
                </h2>
            </div>
            <div class="p-5 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="group">
                        <label for="status" class="block text-xs font-medium text-gray-700 mb-1 flex items-center">
                            <i class="fas fa-toggle-on mr-1.5 text-[#0d5c2f] text-xs"></i>Status *
                        </label>
        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
            <div class="p-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                <h2 class="text-base font-semibold text-gray-900 flex items-center">
                    <i class="fas fa-sticky-note mr-2.5 text-[#0d5c2f] text-base"></i>
                    Additional Notes
                </h2>
            </div>
            <div class="p-5">
                <div class="group">
                    ...
                    <textarea name="notes" id="notes" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-[#0d5c2f] focus:border-[#0d5c2f] text-sm transition-all duration-200 group-hover:border-[#0d5c2f]/50 resize-y">{{ old('notes', $parochialActivity->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-xs text-red-600 flex items-center">
                            <i class="fas fa-exclamation-circle mr-1 text-xs"></i>{{ $message }}
                        </p>
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-1.5 text-sm group-hover:scale-110 transition-transform duration-200"></i>Update Activity
            </button>
        </div>
    </form>
</div>
