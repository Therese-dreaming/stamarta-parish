...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#0d5c2f] to-[#0d5c2f]/90 rounded-xl shadow-sm">
        <div class="px-6 py-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-white">Create Parochial Activity</h1>
                    <p class="text-white/80 mt-1 flex items-center">
                        <i class="fas fa-plus-circle mr-2"></i>Add a new parish event or activity
                    </p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form action="{{ isset($isStaff) && $isStaff ? route('staff.parochial-activities.store') : route('admin.parochial-activities.store') }}" method="POST" class="p-6">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] bg-white">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                            </p>
                ...
                <div class="space-y-6">
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <p id="event_date_help" class="mt-1 text-sm text-gray-500 flex items-center">
                            <i class="fas fa-info-circle mr-1"></i>Select any date that falls on the desired day of the week
                        </p>
                        @error('event_date')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#0d5c2f] focus:border-[#0d5c2f] bg-white">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600 flex items-center">
                            <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                        </p>
