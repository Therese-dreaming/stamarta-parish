...
@section('title', 'Edit Manual Cash Inflow')
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Edit Manual Cash Inflow</h1>
                        <p class="text-gray-600 mt-1">Reference: {{ $manual_cash_inflow->reference_no }}</p>
                    </div>
                </div>
                <div class="flex space-x-3">
                    <a href="{{ route('admin.manual-cash-inflows.show', ['manual_cash_inflow' => $manual_cash_inflow->id]) }}" 
        ...
        <div class="mb-8">
            <div class="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-2xl p-6 shadow-lg">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-yellow-900 mb-2">Editing Pending Cash Inflow</h3>
                        <p class="text-yellow-800">This cash inflow is currently pending approval. You can modify the details before it gets approved or rejected.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-[#0d5c2f] to-[#0a4a26] px-8 py-6">
                        ...
                        <p class="text-white/80 text-sm mt-1">Update the details below to modify the cash inflow</p>
                    </div>

                    <!-- Form Content -->
                    <form action="{{ route('admin.manual-cash-inflows.update', ['manual_cash_inflow' => $manual_cash_inflow->id]) }}" method="POST" class="p-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="0.01" 
                                           max="999999.99"
                                           value="{{ old('amount', $manual_cash_inflow->amount) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <select name="source_type" 
                                        ...
                                        <option value="diocese" {{ old('source_type', $manual_cash_inflow->source_type) === 'diocese' ? 'selected' : '' }}>🏛️ Diocese</option>
                                        <option value="donation" {{ old('source_type', $manual_cash_inflow->source_type) === 'donation' ? 'selected' : '' }}>💰 Donation</option>
                                        <option value="other" {{ old('source_type', $manual_cash_inflow->source_type) === 'other' ? 'selected' : '' }}>📋 Other</option>
                                    </select>
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" 
                                   name="description" 
                                   id="description" 
                                   value="{{ old('description', $manual_cash_inflow->description) }}"
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" 
                                   name="source_details" 
                                   id="source_details" 
                                   value="{{ old('source_details', $manual_cash_inflow->source_details) }}"
                        ...
                        <div id="other_source_specification" class="mb-8 {{ $manual_cash_inflow->source_type === 'other' ? '' : 'hidden' }}">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('other_source_specify', $manual_cash_inflow->other_source_specify) }}"
                                   ...
                                   {{ $manual_cash_inflow->source_type === 'other' ? 'required' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div class="relative">
                                    <select name="ministry_id" 
                                        ...
                                        @foreach($ministries as $ministry)
                                            <option value="{{ $ministry->id }}" {{ old('ministry_id', $manual_cash_inflow->ministry_id) == $ministry->id ? 'selected' : '' }}>
                                                🏛️ {{ $ministry->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" 
                                       name="reference_no" 
                                       id="reference_no" 
                                       value="{{ old('reference_no', $manual_cash_inflow->reference_no) }}"
                                ...
                                <p class="text-xs text-gray-500 flex items-center">
                                    ...
                                    You can modify the reference number if needed
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="notes" 
                                      ...
                                      placeholder="Any additional information or context about this cash inflow (e.g., purpose, conditions, special instructions)">{{ old('notes', $manual_cash_inflow->notes) }}</textarea>
                            @error('notes')
                                <p class="text-sm text-red-600 flex items-center mt-2">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex items-center justify-between p-3 bg-white/60 rounded-xl">
                                    <span class="text-blue-800 font-medium">Amount:</span>
                                    <span class="font-bold text-blue-900">₱{{ number_format($manual_cash_inflow->amount, 2) }}</span>
                                </div>
                                <div class="flex items-center justify-between p-3 bg-white/60 rounded-xl">
                                    <span class="text-blue-800 font-medium">Source Type:</span>
                                    <span class="font-bold text-blue-900">{{ $manual_cash_inflow->getSourceTypeLabel() }}</span>
                                </div>
                                <div class="flex items-center justify-between p-3 bg-white/60 rounded-xl">
                                    <span class="text-blue-800 font-medium">Ministry:</span>
                                    <span class="font-bold text-blue-900">{{ $manual_cash_inflow->ministry ? $manual_cash_inflow->ministry->name : 'General Parish Fund' }}</span>
                                </div>
                                <div class="flex items-center justify-between p-3 bg-white/60 rounded-xl">
                                    <span class="text-blue-800 font-medium">Status:</span>
                                    <span class="font-bold text-blue-900 capitalize">{{ $manual_cash_inflow->status }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-2xl p-6 shadow-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-purple-800 mb-4">If you have questions about editing cash inflows, contact your system administrator.</p>
